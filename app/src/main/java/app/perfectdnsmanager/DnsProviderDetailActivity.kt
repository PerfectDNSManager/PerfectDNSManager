...
class DnsProviderDetailActivity : AppCompatActivity() {
    ...
    private fun showEditProfileDialog(profile: DnsProfile, profileManager: app.perfectdnsmanager.data.ProfileManager) {
    ...
    private fun confirmDeleteProfile(profile: DnsProfile, profileManager: app.perfectdnsmanager.data.ProfileManager) {
        AlertDialog.Builder(this)
