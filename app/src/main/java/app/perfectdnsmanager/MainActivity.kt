...
class MainActivity : AppCompatActivity() {
    ...
    private fun checkForAppUpdate() {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            app.perfectdnsmanager.util.BlockingAuthoritiesManager.syncFromRemote(this@MainActivity)
        }
    }
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            fun whoamiOn(ipv4Only: Boolean): org.json.JSONObject? = try {
                ...
                val req = okhttp3.Request.Builder()
                    .url("https://perfectdnsmanager.app/api/whoami")
                    .build()
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            try {
                ...
                val content = buildString {
                    ...
                    appendLine("---")
                    appendLine("*${getString(R.string.md_generated_by)} [Perfect DNS Manager](https://perfectdnsmanager.app/)*")
                }
    ...
    private fun checkVersionMigration() {
        try {
            ...
            if (savedVersionCode != 0 && savedVersionCode != currentVersionCode) {
                ...
                val profileManager = app.perfectdnsmanager.data.ProfileManager(this)
    ...
    private fun runWirelessPairing(code: String) {
        val progress = AlertDialog.Builder(this)
            ...
            .show()
        lifecycleScope.launch(Dispatchers.IO) {
            val mgr = app.perfectdnsmanager.service.AdbPairingManager(this@MainActivity)
            mgr.pairAndGrant(code, object : app.perfectdnsmanager.service.AdbPairingManager.Callback {
