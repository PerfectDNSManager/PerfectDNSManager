# 2.4.0-beta.3 — xdp.es et profils personnels Control D

- Ajout de xdp.es à la liste des fournisseurs : variantes Standard et Adblock en DoH, DoQ, DoT et DNS classique. Les adresses IPv6 publiées sont incluses dans les profils classiques.
...
Validation : tests JVM des formats Control D, conservation lors de la validation d’import/export, unicité des identifiants des presets et distinction Standard/Adblock. Requêtes DNS réelles vers les deux adresses DoH xdp.es réussies. Tests, lint et compilation exécutés avant publication ; validation sur TV/Fire TV réelle encore nécessaire.
